# -*- coding: utf-8 -*-
"""Copy of “Unsupervised Learning ProjectNLP.ipynb”

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1gvCqtNS0sgzaKUQ5NKpgsu65GPK28tVC
...
file = drive.CreateFile({'id':'1qPfJkAOV2dnbo24F-GD5F8Hml8okybC6'}) # replace the id with id of file you want to access
...
nltk.download('punkt')#punctuaion 标点符号
...
# use the first 1000 data as our training data for fast train 
data = df.loc[:999, 'review_body'].tolist()

data[:11]# 1000个document 1000个数据点
...
def tokenization_and_stemming(text):
    ...
    for word in nltk.word_tokenize(text):#tokenizi
...
tokenization_and_stemming(data[0])#会把一些词变奇怪
...
print ("In total, there are " + str(tfidf_matrix.shape[0]) + \
      " reviews and " + str(tfidf_matrix.shape[1]) + " terms.")#feature还是太多了
...
lda = LatentDirichletAllocation(n_components=5)#可以自己设置 分几类
